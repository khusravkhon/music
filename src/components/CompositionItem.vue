<template>
  <div class="border border-gray-200 p-3 mb-4 rounded">
    ...
    <div v-show="showForm">
      <div
        class="text-while text-center font-bold p-4 mb-4"
        v-if="show_alert"
        :class="alert_variant"
      >
        {{ alert_massage }}
      ...
      >
        ...
        <button
          type="button"
          class="py-1.5 ml-[10px] px-3 rounded text-white bg-gray-600"
          :disabled="in_submission"
          @click.prevent="showForm = false"
        >
          {{ $t("compositionitem.Go Back") }}
        </button>
      </vee-form>
    </div>
  </div>
